  ...
  const renderControls = () => (
    <div className="w-80 shrink-0 bg-bg-secondary flex flex-col border-l border-surface h-full z-10">
      <div className="p-4 flex justify-between items-center shrink-0 border-b border-surface">
        <Text variant={TextVariants.title}>{t('Transform')}</Text>
        <button
          onClick={handleReset}
          data-tooltip={t('Reset Transform')}
          ...
          {currentAdjustments.masks && currentAdjustments.masks.length > 0 && (
            ...
            >
              ...
              <p className="leading-relaxed">
                {t('Transforming updates base geometry. Existing masks may shift, and AI masks must be regenerated.')}
              </p>
            </Text>
          )}
        </div>
        ...
        >
          ...
          >
            ...
            <button
              ...
              data-tooltip={t('Toggle Helper Lines')}
            >
              <LineChart size={18} />
            </button>
